...
@section('title','Adicionar os estudantes')
@section('content')



<form action="{{ route ('secretaria_pedagogica.adicionar_est')}}" method = "post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label>Estudante</label>
                <input class="form-control" rows="2" name="mensagem"  placeholder="" />
