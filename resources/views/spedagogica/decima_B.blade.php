            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="alert-wrap2 shadow-inner wrap-alert-b">
                    ...
                    <div class="alert alert-success">
                        ...
                        <strong>Falta!</strong> Enviadas com Sucesso, <a href="{{ route('secretaria_pedagogica_ondjiva.ver_festudante') }}"><span>Ver</span></a>.
                    </div>
...
<div class="data-table-area mg-b-15">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list">
                            ...
                            <div class="sparkline13-graph">
                                <form action="{{ route ('secretaria_pedagogica_ondjiva.dec_B')}}" method = "post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
           ...
           <div class="form-group row">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="disciplina"> <span class="required">Disciplina</span>
                        ...
                        value="{{ $estudante->id}}">{{$estudante->name}}
                      </div>
