...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">Formação a Enviadas</h3>

    <div class="card-tools">
    <a class="btn btn-app bg-success" href="{{ route('coordenacao.enviar_formacao') }}" >
        ...
        @foreach( $formacoes as $declaracao)
                            <tr>
                              ...
                              <td class="project-actions text-right"  style="display: flex;">
                                <a class="btn btn-info btn-sm" href="/coordenacao/editar_formacao/{{ $declaracao->id}}">
                <i class="fas fa-pencil-alt">
                </i>
                Editar
            </a>
        
            <form action=" /coordenacao/eliminar_form/{{ $declaracao->id}}" method="post">
