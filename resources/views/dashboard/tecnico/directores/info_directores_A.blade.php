...
<section class="content">
      <div class="container-fluid">
        <div class="row">
        @foreach( $administrativos as $dados) 
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid"
                       src="/media/administracao/img/{{$dados->photo}}"
          ...
          <div class="col-md-9">
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    <!-- Post -->
                         ...
                         <a class="btn btn-primary btn-sm" href=" /media/director/pdf/{{$dados->bilhete}}" download = "Bilhete {{ $dados->name}}">
                ...
                <a class="btn btn-primary btn-sm" href="/media/director/pdf/{{$dados->hl}}"  download = "Bilhete {{ $dados->name}}>
                ...
                <a class="btn btn-primary btn-sm" href="/media/director/cv/{{$dados->cv}}" download = "Hacaobilita {{ $dados->name}}">
                ...
                <a class="btn btn-primary btn-sm" href=" /media/director/gm/{{$dados->gm}}" download = "Guia {{ $dados->name}}">
