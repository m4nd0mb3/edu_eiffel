...
@section('title','Notas individuais')
@section('content')
...
<div class="card">
  ...
  <td class="project-actions text-right" >
      <a class="btn btn-primary btn-sm" href="/coordenacao/ver_info_nota_validada_individual/{{ $prova->liceu}}/{{ $prova->professor_id}}/{{ $prova->created_at}}">
