            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="alert-wrap2 shadow-inner wrap-alert-b">
                    ...
                    <div class="alert alert-success">
                        ...
                        <strong>Notas!</strong> Enviadas com Sucesso, <a href="{{ route('secretaria_geral.ver_festudante') }}"><span>Ver</span></a>.
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="alert-wrap2 shadow-inner wrap-alert-b">
                    ...
                    <div class="alert alert-danger alert-mg-b">
                        ...
                        <strong>Erro!</strong> Notas não enviadas, <a href="{{ route('secretaria_geral.ver_nota') }}"><span>Ver</span></a>..
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                ...
                @foreach( $classes as $professor) 
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <a href="/secretaria_geral/decima_A/{{ Auth::guard('secretaria_geral')->user()->liceu }}/{{$professor->id}}">
