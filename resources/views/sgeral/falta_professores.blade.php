            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="alert-wrap2 shadow-inner wrap-alert-b">
                    ...
                    <div class="alert alert-success">
                        ...
                        <strong>Falta!</strong> Enviadas com Sucesso, <a href="{{ route ('secretaria_geral.ver_falta')}}"><span>Ver</span></a>.
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list">
                            ...
                            <div class="sparkline13-graph">
                                <form action="{{ route ('secretaria_geral.falta_professor')}}" method = "post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
