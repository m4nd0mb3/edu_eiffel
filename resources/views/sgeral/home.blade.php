...
@section('title','Secretario Geral')
@section('content')
      ...
      <div class="container-fluid">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger 	">
              ...
              <a href="{{ route('secretaria_geral.alterar_senha')}}" class="small-box-footer">Clique para Alterar <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <!-- small box -->
