            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Registrar Secretario</h2>
                        <form action="{{ route('secretaria_administrativa.create') }}" method="post">
                    ...
                    @endforeach 
                          ...
                          <div class="form-group ">
                              ...
                              <select name="situacao" id="required" class="form-control "  style="width: 100%;">
                          ...
                          <div class="form-group ">
                           ...
                           <select name="tipo" id="required" class="form-control "  style="width: 100%;">
                            
                             <option value="2">Secretario Administrativo</option>
