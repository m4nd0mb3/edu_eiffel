                         ...
                         <div class="row">
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-danger 	">
                               ...
                               @foreach( $professores as $professor) 
                                ...
                                <a href="/pedagogia/ver_boletim_professor/{{ $professor->id}}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
                                @endforeach 
                            ...
                            <div class="col-lg-3 col-6">
                              ...
                              @foreach( $professores as $professor) 
                                ...
                                <a href="/pedagogia/ver_info_falta_professor/{{ $professor->liceu}}/{{ $professor->id}}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
                            ...
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-danger">
                                ...
                                <a href="{{ route('pedagogia.declaracoes_professores') }}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-danger">
                                ...
                                <a href="/pedagogia/ver_plano_professor/{{ $professor->id}}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
                             ...
                             <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-danger">
                                ...
                                <a href="/pedagogia/ver_orientacao_professor/{{ $professor->id}}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
