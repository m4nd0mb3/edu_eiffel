...
<form action="/pedagogia/dec_A/{{ Auth::guard('pedagogia')->user()->liceu }}/{{$estudante->classe}}" method = "post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
