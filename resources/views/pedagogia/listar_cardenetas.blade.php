                ...
                Ver
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a target="blank" href="/pedagogia/imprimir_cardeneta/{{$cardeneta->liceu}}/{{$cardeneta->classe}}/{{$cardeneta->trimestre_id}}"> <i class="fa-solid fa-eye"></i> Ver Caderneta</a></li>
                                        </ul>
                                    </div>
