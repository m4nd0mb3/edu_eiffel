...
<section class="content">
      ...
      <div class="card">
        ...
        <td class="project-actions text-right" >
            <a class="btn btn-primary btn-sm" href="/pedagogia/ver_info_nota_professor_validada/{{ $prova->professor_id}}/{{ $prova->created_at}}">
                <i class="fa-solid fa-eye"></i>
                
                Ver
            </a>
            <a class="btn btn-info btn-sm" href="/pedagogia/editar_provas/{{ $prova->created_at}}">
