...
<section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title" style=" font-weight:bolder ;">Notas Antigas Parte 1</h3> 
        ...
        <td class="project-actions text-right" >
            <a class="btn btn-primary btn-sm" href="/pedagogia/ver_info_nota_professor_dois/{{ $prova->created_at}}">
