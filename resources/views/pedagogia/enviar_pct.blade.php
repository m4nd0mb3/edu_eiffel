            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="alert-wrap2 shadow-inner wrap-alert-b">
                    ...
                    <div class="alert alert-danger alert-mg-b">
                        ...
                        <strong>Erro!</strong> Notas não enviadas, <a href="{{ route('pedagogia.ver_nota') }}"><span>Ver</span></a>..
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                ...
                @foreach( $classes as $professor) 
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <a href="/pedagogia/classe/{{ Auth::guard('pedagogia')->user()->liceu }}/{{$professor->id}}">
