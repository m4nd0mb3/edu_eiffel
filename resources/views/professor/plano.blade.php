...
@section('title','Enviar Plano de aula')
@section('content')


<form action="{{ route ('professor.plano')}}" method = "post" enctype="multipart/form-data">
    ...
    <div class="card card-default">
      <div class="card-header">
        <h3 class="card-title" style="font-weight: bolder; color: red;">Selecione os dados da Preparação da Aula</h3>
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label>Tipo De preparação de Aula</label>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="2" name="tema" style="width: 700px;" placeholder=""></textarea>
                </div>
              </div>
