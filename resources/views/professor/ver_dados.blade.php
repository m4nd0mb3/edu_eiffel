            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted">
                            ...
                            {!! QrCode::size(100)->generate('http://127.0.0.1:8000/professor/info_qr') !!}
            ...
            <div class="card">
              <div class="card-header p-2">
                ...
                <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Outros dados</a></li>
                  ...
                  <li class=""><a class="nav-link" href="/professor/form/{{$professor->id}}"  style="color: red
                  ;">Editar Dados</a></li>
          
                    <li class=""><a class="nav-link" href="{{ route('professor.alterar_senha')}}"  style="color: red
                      ;">Alterar Senha</a></li>
                  <li class="nav-item"></li>
                  </ul>
              </div><!-- /.card-header -->
                         ...
                         <div class="row">
                            ...
                            <div class="col-lg-3 col-6">
                              ...
                              <div class=" small-box bg-danger">
                                ...
                                <a href="{{ route('professor.ver_falta') }}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-danger">
                                ...
                                <a href="{{ route('professor.solicitacao_enviadas') }}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-danger">
                                ...
                                <a href="{{ route('professor.plano_enviados') }}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
