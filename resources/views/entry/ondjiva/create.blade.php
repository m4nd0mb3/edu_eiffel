...
<head>
  ...
  <title>PDF Candidato Ondjiva</title>
</head>
<body>
...
@foreach( $estudantes as $estudante) 
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            ...
                            <p> <br>
                            A Direção do Liceu Eiffel de Ondjiva, vem por intermédio deste comunicar que a inscrição do candidato <span>{{$estudante->name}}</span>
                  ...
                  e com o bilhete numero <span>{{$estudante->bi}}</span> fez a sua inscrição no dia <span>{{$estudante->created_at}}</span> pelo link
                       link:  <a href="https://liceueiffel.redeeiffel.ao/formulario_ndalatando.">https://liceueiffel.redeeiffel.ao/formulario_ondjiva.</a>
                            </p>
