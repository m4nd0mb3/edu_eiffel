...
<head>
  ...
  <title>PDF Candidato Caxito</title>
</head>
<body>

<div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="/ondjiva/img/renom.png" alt="" width="150px" height="150px"/></a>
                <strong><a href="index.html"><img src="/ondjiva/img/rede.png" alt="" /></a></strong>
            </div>

            <?php
    $path = 'ondjiva/img/renom.png';
...
@foreach( $estudantes as $estudante) 
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            ...
                            <p> <br>
                            A Direção do Liceu 397 Eiffel do Dande, vem por intermédio deste comunicar que a inscrição do candidato <span>{{$estudante->name}}</span>
                  ...
                  e com o bilhete numero <span>{{$estudante->bi}}</span> fez a sua inscrição no dia <span>{{$estudante->created_at}}</span> pelo link
                       link:  <a href="https://liceueiffel.redeeiffel.ao/formulario_ndalatando.">https://liceueiffel.redeeiffel.ao/formulario.</a>
                            </p>
