...
<head>
  ...
  <title>Liceu 397 Eiffel do Dande</title>
...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <p class = "msg">{{ session ('msg') }} clique aqui para baixar o comprovativon <a href="/pdf"> clique aqui para baixar o recibo da Inscrição</a></p>
    ...
    <div class="container">
      ...
      <div class="row" data-aos="fade-in">
        ...
        <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
          <form  action="/form_caxito" method = "post"  class="form" enctype="multipart/form-data">
