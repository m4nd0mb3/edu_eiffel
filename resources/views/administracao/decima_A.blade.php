                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list">
                            ...
                            <div class="sparkline13-graph">
                                <form action="{{ route ('administracao_ondjiva.dec_A')}}" method = "post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              ...
                              <textarea type="text" id="mensagem" name="mensagem" rows="5" required="required" class="form-control " style="height: 100px;" max ></textarea>
                            </div>
                          </div>
