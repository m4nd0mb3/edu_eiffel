...
@section('title','Enviar Falta Para Funcionarios')
@section('content')
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="alert-wrap2 shadow-inner wrap-alert-b">
                    ...
                    <div class="alert alert-success">
                        ...
                        <strong>Falta!</strong> Enviadas com Sucesso, <a href="{{ route('administracao_ondjiva.ver_faltaf') }}"><span>Ver</span></a>.
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="caption pro-sl-hd">
                                            <span class="caption-subject"><b>Enviar faltas para os Funcionarios</b></span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list">
                            ...
                            <div class="sparkline13-graph">
                                <form action="{{ route ('administracao_ondjiva.falta_funcionario')}}" method = "post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <select name="funcionario" id="required" class="form-control ">
