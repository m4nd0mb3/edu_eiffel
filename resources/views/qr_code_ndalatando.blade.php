  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
    ...
    <ul class="navbar-nav" >
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('coordenacao.home') }}" class="nav-link">Pagina Inicial</a>
      </li>

      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('coordenacao.ver_dados') }}" class="nav-link">Perfil</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto" >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i> Sem mensagens
      ...
      <li class="nav-item dropdown">
      <a  class="nav-link" href="{{ route('coordenacao.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color: red;">

<form action="{{ route('coordenacao.logout') }}" id="logout-form" method="post">@csrf</form>
...
<i class="fa-solid fa-right-to-bracket"></i>
  ...
  <aside class="main-sidebar  sidebar-dark-primary elevation-4" id="side_bar" >
    ...
    <a href="" class="brand-link" style=" display: flex; align-items: center; justify-content: center; flex-direction: column; ">
      <span class="brand-text font-weight-light" style="text-align: center;">Coordenador <br>
    da <br>
Rede Eiffel</span>
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
        <a href="{{ route('coordenacao.home') }}" class="d-block"> 
          {{ Auth::guard('coordenacao')->user()->name }}</a>
      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('coordenacao.boletim_liceu') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('coordenacao.plano_liceu') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('coordenacao.orientacao_liceu') }}" class="nav-link" >
              ...
              <p>
                Orientações
                      ...
                      <li class="nav-item has-treeview">
                        <a href="{{ route('coordenacao.ver_formacao') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('coordenacao.directores_liceu') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('coordenacao.professor_liceu') }}" class="nav-link" >
...
<p>
  ...
  <div class="content-wrapper" id="centro" style=" 
