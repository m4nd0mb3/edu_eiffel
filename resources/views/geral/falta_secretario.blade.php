...
<form action="{{ route ('geral.secretario')}}" method = "post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select name="secretario_id" id="required" class="form-control ">
