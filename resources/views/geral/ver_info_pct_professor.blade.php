...
@section('title','Validar PCT')
@section('content')



@foreach( $estudantess as $prova) 
            <form action="/geral/enviar_nota_pct/{{$prova->liceu}}/{{$prova->classe}}/{{$prova->created_at}}" method = "post" enctype="multipart/form-data">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input id="data" name="created_at" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text"value="{{$professor->created_at}}" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
                @endforeach      
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              @foreach( $provas as $estudante) 
                                            <tr>
                                                ...
                                                <td ><input type="text" readonly value="@if($estudante->nota == null)0 @else {{ $estudante->nota}} @endif" id="nota" required="required" class="form-control  " name="nota[]" /> </td>
                                                ...
                                                <td>{{ $estudante->professor->name}}</td>
