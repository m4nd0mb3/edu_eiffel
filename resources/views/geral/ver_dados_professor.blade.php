                         ...
                         <div class="row">
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-danger 	">
                                ...
                                <a href="/geral/ver_boletim_professor/{{ $dados->id}}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                              ...
                              <div class=" small-box bg-danger">
                                ...
                                <a href="/geral/ver_info_falta_professor/{{ $dados->liceu}}/{{ $dados->id}}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-danger">
                                ...
                                <a href="{{ route('geral.declaracoes_professores') }}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                              ...
                              <div class="small-box bg-danger">
                                ...
                                <a href="/geral/ver_plano_professor/{{ $dados->id}}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
                              ...
                              <div class="small-box bg-danger">
                                ...
                                <a href="/geral/ver_orientacao_professor/{{ $dados->id}}" class="small-box-footer">Ver todas <i class="fas fa-arrow-circle-right"></i></a>
                              </div>
                            </div>
