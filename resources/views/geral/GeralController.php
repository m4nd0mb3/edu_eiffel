...
function pedagogico(Request $request){
    ...
    if($data){
        return redirect()->route('geral.falta_pedagogico')->with('success','Falta Enviada das Com sucesso');
    }else{
...
function secretario(Request $request){
    ...
    if($data){
        return redirect()->route('geral.falta_secretario')->with('success','Falta Enviada das Com sucesso');
    }else{
        return redirect()->back()->with('fail','Notas não Enviadas');
    }
...
function ver_nota(){
    ...
    public function ver_boletim_professor(){
    ...
    public function ver_dado_estudante($id){
        ...
        return view('geral.ver_dados_estudante', ['estudantes'=>$estudantes]);
    }
...
function falta_funcionario(Request $request){
  ...
  if($data){
    return redirect()->route('geral.f_funcionario')->with('success','Falta Enviada das Com sucesso');
}else{
    return redirect()->back()->with('fail','Notas não Enviadas');
}
}
...
function noti_pedagogico(Request $request){
    ...
    if($data){
        return redirect()->route('geral.notificacao_pedagogico')->with('success','Falta Enviada das Com sucesso');
    }else{
        return redirect()->back()->with('fail','Notas não Enviadas');
    }
...
function noti_administrativo(Request $request){
    ...
    if($data){
        return redirect()->route('geral.notificacao_administrativo')->with('success','Falta Enviada das Com sucesso');
    }else{
        return redirect()->back()->with('fail','Notas não Enviadas');
    }
...
function noti_professor(Request $request){
    ...
    if($data){
        return redirect()->route('geral.notificacao_professor')->with('success','Falta Enviada das Com sucesso');
    }else{
        return redirect()->back()->with('fail','Notas não Enviadas');
    }
...
function dec_A(Request $request, $liceu, $classe){
  ...
  if($data){
    return redirect()->route('geral.enviar_nestudante')->with('success','Falta Enviada das Com sucesso');
}else{
    return redirect()->back()->with('fail','Notas não Enviadas');
}}
...
function noti_secretario(Request $request){
    ...
    if($data){
        return redirect()->route('geral.notificacao_secretario')->with('success','Falta Enviada das Com sucesso');
    }else{
        return redirect()->back()->with('fail','Notas não Enviadas');
    }
...
function formacao(Request $request){
    ...
    if($data){
        return redirect()->route('geral.enviar_formacao')->with('success','Falta Enviada das Com sucesso');
    }else{
        return redirect()->back()->with('fail','Notas não Enviadas');
    }
...
$count_planos = count($planos);
    ...
    return view('geral.home', ['count_formacoes' => $count_formacoes,'count_estudantes' => $count_estudantes,'count_faltas' => $count_faltas,'count_orientacoes' => $count_orientacoes
    ...
    function enviar_pct(){
     ...
     return view('geral.ver_nota_pct', ['totals' => $totals]);
        ...
        public function ver_info_pct_professor($created_at){
            ...
            $estudantess = PCT::where('created_at', '=', $created_at)->get();
        ...
        function enviar_nota_pct(Request $request, $liceu, $classe,$created_at){
            ...
            $estudantes = PCT::where('liceu', '=', $liceu )->where('classe', '=',$classe)
    ...
    function tipo_boletim(){
        ...
        return view('geral.tipo_boletim');
    ...
    public function __construct(Excel $excel){
       ...
       */
       ...
       $invoices = DMark::where('liceu', '=', $id->liceu )->where('classe', '=',$classe)->get();
