...
@section('title','Perfil Dos Directores')
@section('content')
          ...
          <div class="col-md-9">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a class="btn btn-primary btn-sm" href=" /media/professor/pdf/{{$professor->bilhete}}" download = "Bilhete {{ $professor->name}}">
                ...
                <a class="btn btn-primary btn-sm" href="/media/professor/pdf/{{$professor->hl}}">
                ...
                <a class="btn btn-primary btn-sm" href="/media/professor/cv/{{$professor->cv}}" download = "Hacaobilita {{ $professor->name}}">
                ...
                <a class="btn btn-primary btn-sm" href=" /media/professor/gm/{{$professor->gm}}" download = "Guia {{ $professor->name}}">
