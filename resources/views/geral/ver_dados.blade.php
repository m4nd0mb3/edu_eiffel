                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="profile-info-inner">
                            <div class="profile-img">
                                <img src="/media/geral/img/{{$professor->photo}}" alt="" />
                            </div>
                            ...
                            @endif</p>
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                        <div class="address-hr biography">
                                                            ...
                                                            <a href="/media/geral/pdf/{{$professor->bilhete}}" download = "Bilhete {{ $professor->name}}">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                        <div class="address-hr biography">
                                                            ...
                                                            <a href="/media/geral/pdf/{{$professor->hl}}" download = "Hacaobilita {{ $professor->name}}">
                                                              <button data-toggle="tooltip" title="Baixar" class="pd-setting-ed">	<i class="fa fa-download"></i></button>
</p>                                                        </a>                   
                                                        </p>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                        <div class="address-hr biography">
                                                            ...
                                                            <a href="/media/geral/cv/{{$professor->cv}}" download = "Hacaobilita {{ $professor->name}}">
                                                              <button data-toggle="tooltip" title="Baixar" class="pd-setting-ed">	<i class="fa fa-download"></i></button>
</p>                                                        </a>   </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                        <div class="address-hr biography">
                                                            ...
                                                            <a href="/media/geral/gm/{{$professor->gm}}" download = "Guia {{ $professor->name}}">
                                                              <button data-toggle="tooltip" title="Baixar" class="pd-setting-ed">	<i class="fa fa-download"></i></button>
</p>                                                        </a>
