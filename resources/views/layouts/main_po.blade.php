...
<div class="wrapper" >
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
    ...
    <ul class="navbar-nav" >
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('professor.home') }}" class="nav-link">Pagina Inicial</a>
      </li>

      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('professor.ver_dados') }}" class="nav-link">Perfil</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto" >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="{{ route('professor.notificacao') }}" class="dropdown-item">
          ...
          <div class="dropdown-divider"></div>
          <a href="{{ route('professor.notificacao') }}" class="dropdown-item dropdown-footer">Todas as notificações</a>
        </div>
      </li>

      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="{{ route('professor.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color: red;">

                         <form action="{{ route('professor.logout') }}" id="logout-form" method="post">@csrf</form>
  ...
  <aside class="main-sidebar  sidebar-dark-primary elevation-4" id="side_bar" >
    ...
    <a href="" class="brand-link" style=" display: flex; align-items: center; justify-content: center; flex-direction: column; ">
      <span class="brand-text font-weight-light" style="text-align: center;"> @if(Auth::guard('professor')->user()->liceu == 1)
...
@endif</span>
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"> Professor  {{ Auth::guard('professor')->user()->name }}</a>
        </div>
      </div>
      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open"  >
            <a href="{{ route('professor.home') }}" class="nav-link active" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('professor.estudantes') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('professor.tipo_boletim') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('professor.plano_enviados') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('professor.orientacoes_enviadas') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('professor.ver_falta') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('professor.ver_formacao') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('professor.solicitacao_enviadas') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('professor.notificacao') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('professor.ver_relatos') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a  class="nav-link" href="{{ route('professor.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color: red;">
  ...
  <div class="content-wrapper" id="centro" style=" @if(Auth::guard('professor')->user()->liceu == 1)
