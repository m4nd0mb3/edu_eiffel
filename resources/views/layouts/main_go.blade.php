  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
    ...
    <ul class="navbar-nav" >
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('geral.home') }}" class="nav-link">Pagina Inicial</a>
      </li>

      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('geral.ver_dados') }}" class="nav-link">Perfil</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto" >
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-warning navbar-badge"> {{$count_not}}</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header">{{$count_not}} Notificações</span>
          <div class="dropdown-divider"></div>
          @foreach ($notificacoes as $notificacao) 
          <a href="{{ route('geral.noti_recebida') }}" class="dropdown-item">
            
            <i class="fas fa-envelope mr-2"></i> {{$notificacao->mensagem}}
            <span class="float-right text-muted text-sm">{{$notificacao->created_at}}</span>
          </a>
          @endforeach
          ...
          <div class="dropdown-divider"></div>
          <a href="{{ route('geral.noti_recebida') }}" class="dropdown-item dropdown-footer">Todas as notificações</a>
        </div>
      </li>


      <li class="nav-item dropdown">
      <a  class="nav-link" href="{{ route('geral.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color: red;">

<form action="{{ route('geral.logout') }}" id="logout-form" method="post">@csrf</form>
...
<i class="fa-solid fa-right-to-bracket"></i>
  ...
  <aside class="main-sidebar  sidebar-dark-primary elevation-4" id="side_bar" >
    <!-- Brand Logo -->
    <a href="" class="brand-link" style=" display: flex; align-items: center; justify-content: center; flex-direction: column; ">
      <span class="brand-text font-weight-light" style="text-align: center;"> @if(Auth::guard('geral')->user()->liceu == 1)
        Liceu Nº 397 <br> Eiffel de Dande

    @elseif(Auth::guard('geral')->user()->liceu == 2)
        Liceu Eiffel de  Malanje
    @elseif(Auth::guard('geral')->user()->liceu == 3)
Liceu Nº 30 <br> Eiffel de Cazengo
...
@endif</span>
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
        <a href="{{ route('geral.home') }}" class="d-block"> Director Geral <br>
          {{ Auth::guard('geral')->user()->name }}</a>
      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('geral.diretores') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('geral.professores') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('geral.secretarios') }}" class="nav-link" >
                <i class="fa-solid fa-user-tie"></i>
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('geral.estudantes') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('geral.funcionario') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('geral.tipo_boletim') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('geral.plano_enviados') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('geral.orientacoes_enviadas') }}" class="nav-link" >
              ...
              <p>
                Orientações
                      ...
                      <li class="nav-item has-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('geral.ver_falta') }}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Administração</p>
                            </a>
                          </li>
                          <li class="nav-item">
                            <a href="{{ route('geral.ver_falta_professor') }}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Professores</p>
                            </a>
                          </li>
                          <li class="nav-item">
                            <a href="{{ route('geral.ver_faltaf') }}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Funcionarios</p>
                            </a>
                          </li>
                          <li class="nav-item">
                            <a href="{{ route('geral.ver_festudante') }}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Estudantes</p>
                            </a>
                          </li>
                      ...
                      <li class="nav-item has-treeview">
                        <a href="{{ route('geral.ver_formacao') }}" class="nav-link">
                      ...
                      <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                          <li class="nav-item">
                          <a href="
                          {{ route('geral.declaracoes_professores') }}
                          " class="nav-link">
                          ...
                          <li class="nav-item">
                            <a href="{{ route('geral.declaracoes_estudantes') }}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Estudantes</p>
                            </a>
                          </li>
                      ...
                      <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                          <li class="nav-item">
                            <a href="{{ route('geral.notificacao_professor') }}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Professores</p>
                            </a>
                          </li>
                          <li class="nav-item">
                            <a href="{{ route('geral.enviar_nestudante') }}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Estudantes</p>
                            </a>
                          </li>
                          ...
                          <li class="nav-item">
                            <a href="{{ route('geral.notificacao_secretario') }}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Secretarios</p>
                            </a>
                          </li>
                          ...
                          <li class="nav-item">
                            <a href="{{ route('geral.notificacao_pedagogico') }}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Diretor  Pedagogico</p>
                            </a>
                          </li>
                          <li class="nav-item">
                            <a href="{{ route('geral.notificacao_administrativo') }}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
          <a href="https://redeeiffel.ao:2096/" class="nav-link">
            <a href="" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('geral.ver_relatos') }}" class="nav-link">
...
<p>
  ...
  <div class="content-wrapper" id="centro" style=" @if(Auth::guard('geral')->user()->liceu == 1)
    background-image: url('/estilo/dist/img/entrada_caxito-min.jpg')

                 @elseif(Auth::guard('geral')->user()->liceu == 2)
                                          background-image: url('/estilo/dist/img/malanje-min.jpg')

                                          @elseif(Auth::guard('geral')->user()->liceu == 3)
                                          background-image: url('/estilo/dist/img/ndalatando.jpg')

                                          @elseif(Auth::guard('geral')->user()->liceu == 4)
                                                
                                          background-image: url('/estilo/dist/img/ondjivaSlide-min.png')
