...
<div class="wrapper" >
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
    ...
    <ul class="navbar-nav" >
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('secretaria_pedagogica.ver_dados') }}" class="nav-link">Perfil</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto" >
      ...
      <li class="nav-item dropdown">
      <a class="nav-link" data-toggle="dropdown" href="{{ route('secretaria_pedagogica.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color: red;">

<form action="{{ route('secretaria_pedagogica.logout') }}" id="logout-form" method="post">@csrf</form>
...
<i class="fa-solid fa-right-to-bracket"></i>
  ...
  <aside class="main-sidebar  sidebar-dark-primary elevation-4" id="side_bar" >
    ...
    <a href="index3.html" class="brand-link" style=" display: flex; align-items: center; justify-content: center; flex-direction: column; ">
      <span class="brand-text font-weight-light" style="text-align: center;"> @if(Auth::guard('secretaria_pedagogica')->user()->liceu == 1)
...
@endif</span>
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Secretário Pedagogico  <br> {{ Auth::guard('secretaria_pedagogica')->user()->name }}</a>
        </div>
      </div>
      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open"  >
            <a href="{{ route('secretaria_pedagogica.home') }}" class="nav-link active" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('secretaria_pedagogica.estudantes') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('secretaria_pedagogica.professores') }}" class="nav-link" >
    ...
    {{ route('secretaria_pedagogica.plano_enviados') }}
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('secretaria_pedagogica.orientacoes_enviadas') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('secretaria_pedagogica.declaracoes_estudantes') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('secretaria_pedagogica.falta_professores') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Professores</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('secretaria_pedagogica.falta') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Estudantes</p>
                </a>
              </li>
  ...
  <div class="content-wrapper" id="centro" style=" @if(Auth::guard('secretaria_pedagogica')->user()->liceu == 1)
    background-image: url('/estilo/dist/img/entrada_caxito-min.jpg')
