...
<head>
  ...
  <style>
   ...
   #centro{
    background-image: url('/estilo/dist/img/h.JPG')
   }
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
    ...
    <ul class="navbar-nav" >
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('pedagogia.home') }}" class="nav-link">Pagina Inicial</a>
      </li>

      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('pedagogia.ver_dados') }}" class="nav-link">Perfil</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto" >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="{{ route('pedagogia.noti_recebida') }}" class="dropdown-item">
          ...
          <div class="dropdown-divider"></div>
          <a href="{{ route('pedagogia.noti_recebida') }}" class="dropdown-item dropdown-footer">Todas as notificações</a>
        </div>
      </li>

      <li class="nav-item dropdown">
      <a class="nav-link" data-toggle="dropdown" href="{{ route('pedagogia.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color: red;">

<form action="{{ route('pedagogia.logout') }}" id="logout-form" method="post">@csrf</form>
...
<i class="fa-solid fa-right-to-bracket"></i>
  ...
  <aside class="main-sidebar  sidebar-dark-primary elevation-4" id="side_bar" >
    ...
    <a href="index3.html" class="brand-link" style=" display: flex; align-items: center; justify-content: center; flex-direction: column; ">
      <span class="brand-text font-weight-light" style="text-align: center;"> @if(Auth::guard('pedagogia')->user()->liceu == 1)
                                              Caxito
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"> Director  {{ Auth::guard('pedagogia')->user()->name }}</a>
        </div>
      </div>
      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open"  >
            <a href="{{ route('pedagogia.home') }}" class="nav-link active" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('pedagogia.estudantes') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('pedagogia.professores') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('pedagogia.tipo_boletim') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('pedagogia.plano_enviados') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('pedagogia.orientacoes_enviadas') }}" class="nav-link" >
              ...
              <p>
                Orientações
                      ...
                      <li class="nav-item has-treeview">
                        <a href="{{ route('pedagogia.ver_formacao') }}" class="nav-link">
                      ...
                      <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                          <li class="nav-item">
                            <a href="{{ route('pedagogia.declaracoes_professores') }}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Professores</p>
                            </a>
                          </li>
                          <li class="nav-item">
                            <a href="{{ route('pedagogia.declaracoes_estudantes') }}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Estudantes</p>
                            </a>
                          </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('pedagogia.ver_falta') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Professores</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('pedagogia.ver_festudante') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Estudantes</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('pedagogia.enviar_notificacao') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Professores</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('pedagogia.enviar_nestudante') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Estudantes</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ route('pedagogia.ver_totalnotificacoes') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('pedagogia.ver_relatos') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
          <a  class="nav-link" href="{{ route('pedagogia.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color: red;">
...
<p>
  ...
  <div class="content-wrapper" id="centro" style=" @if(Auth::guard('pedagogia')->user()->liceu == 1)
