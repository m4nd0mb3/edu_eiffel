...
<head>
  ...
  <style>
   ...
   #side_bar{
    background-image: linear-gradient(rgba(24, 27, 191, 0.557),rgb(35, 35, 225),rgba(28, 5, 201, 0.895));
   }
...
<div class="wrapper" >
  ...
  <div class="content-wrapper" id="centro" style=" @if(Auth::guard('administracao')->user()->liceu == 1)
    background-image: url('/estilo/dist/img/entrada_caxito-min.jpg')

                 @elseif(Auth::guard('administracao')->user()->liceu == 2)
                                          background-image: url('/estilo/dist/img/malanje-min.jpg')

                                          @elseif(Auth::guard('administracao')->user()->liceu == 3)
                                          background-image: url('/estilo/dist/img/ndalatando.jpg')

                                          @elseif(Auth::guard('administracao')->user()->liceu == 4)
