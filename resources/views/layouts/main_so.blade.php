...
<head>
  ...
  <style>
   ...
   #side_bar{
    background-image: linear-gradient(rgba(24, 27, 191, 0.557),rgb(35, 35, 225),rgba(242, 245, 248, 0.895));
   }
...
<div class="wrapper" >
  ...
  <div class="content-wrapper" id="centro" style=" @if(Auth::guard('secretaria_administrativa')->user()->liceu == 1)
    background-image: url('/estilo/dist/img/entrada_caxito-min.jpg')
