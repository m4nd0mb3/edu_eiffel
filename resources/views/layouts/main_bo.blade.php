  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
    ...
    <ul class="navbar-nav" >
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('biblioteca.home') }}" class="nav-link">Pagina Inicial</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto" >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="s" class="dropdown-item dropdown-footer">Todas as notificações</a>
        </div>
      </li>

      <li class="nav-item dropdown">
      <a class="nav-link" data-toggle="dropdown" href="{{ route('biblioteca.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color: red;">

<form action="{{ route('biblioteca.logout') }}" id="logout-form" method="post">@csrf</form>
...
<i class="fa-solid fa-right-to-bracket"></i>
  ...
  <aside class="main-sidebar  sidebar-dark-primary elevation-4" id="side_bar" >
    <!-- Brand Logo -->
    <a href="{{ route('biblioteca.home') }}" class="brand-link" style=" display: flex; align-items: center; justify-content: center; flex-direction: column; ">
      <span class="brand-text font-weight-light" style="text-align: center;"><br>
        
        @if(Auth::guard('biblioteca')->user()->liceu == 1)
        Liceu Eiffel de Caxito
       @elseif(Auth::guard('biblioteca')->user()->liceu == 2)
              Liceu Eiffel de Malanje
     @elseif(Auth::guard('biblioteca')->user()->liceu == 3)
       Liceu Eiffel Ndalatando

     @elseif(Auth::guard('biblioteca')->user()->liceu == 4)
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"> biblioteca  {{ Auth::guard('biblioteca')->user()->name }} <br>
        
          @if(Auth::guard('biblioteca')->user()->classe == 1)
          10ª A
         @elseif(Auth::guard('biblioteca')->user()->classe == 2)
                 10ª B
       @elseif(Auth::guard('biblioteca')->user()->classe == 3)
          11ª A

       @elseif(Auth::guard('biblioteca')->user()->classe == 4)
          11ª B
        @elseif(Auth::guard('biblioteca')->user()->classe == 4)
          12ª A
       @elseif(Auth::guard('biblioteca')->user()->classe == 4)
      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a  class="nav-link" href="{{ route('biblioteca.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color: red;">
  ...
  <div class="content-wrapper" id="centro" style=" @if(Auth::guard('biblioteca')->user()->liceu == 1)
