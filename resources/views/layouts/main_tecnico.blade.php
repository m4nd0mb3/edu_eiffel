  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
    ...
    <ul class="navbar-nav" >
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('tecnico.home') }}" class="nav-link">Pagina Inicial</a>
      </li>

      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('tecnico.ver_dados') }}" class="nav-link">Perfil</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto" >
      ...
      <li class="nav-item dropdown">
      <a  class="nav-link" href="{{ route('tecnico.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color: red;">

<form action="{{ route('tecnico.logout') }}" id="logout-form" method="post">@csrf</form>
...
Rede Eiffel</span>
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
        <a href="{{ route('tecnico.home') }}" class="d-block"> 
          {{ Auth::guard('tecnico')->user()->name }}</a>
      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('tecnico.boletim_liceu') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('tecnico.plano_liceu') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('tecnico.orientacao_liceu') }}" class="nav-link" >
              ...
              <p>
                Orientações
                      ...
                      <li class="nav-item has-treeview">
                        <a href="{{ route('tecnico.ver_formacao') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('tecnico.directores_liceu') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('tecnico.professor_liceu') }}" class="nav-link" >
