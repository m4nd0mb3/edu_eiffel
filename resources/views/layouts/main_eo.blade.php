  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
    ...
    <ul class="navbar-nav" >
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('estudante.home') }}" class="nav-link">Pagina Inicial</a>
      </li>

      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('estudante.ver_dados') }}" class="nav-link">Perfil</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto" >
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="{{ route('estudante.notificacao') }}" class="dropdown-item dropdown-footer">Todas as notificações</a>
        </div>
      </li>

      <li class="nav-item dropdown">
      <a class="nav-link" data-toggle="dropdown" href="{{ route('estudante.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color: red;">

<form action="{{ route('estudante.logout') }}" id="logout-form" method="post">@csrf</form>
...
<i class="fa-solid fa-right-to-bracket"></i>
  ...
  <aside class="main-sidebar  sidebar-dark-primary elevation-4" id="side_bar" >
    <!-- Brand Logo -->
    <a href="{{ route('estudante.home') }}" class="brand-link" style=" display: flex; align-items: center; justify-content: center; flex-direction: column; ">
      <span class="brand-text font-weight-light" style="text-align: center;"><br>
    ...
    <div class="sidebar" >
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"> Estudante  {{ Auth::guard('estudante')->user()->name }} <br>
      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open"  >
            <a href="{{ route('estudante.home') }}" class="nav-link active" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('estudante.mark') }}" class="nav-link" >
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('estudante.orientacao') }}" class="nav-link" >
              ...
              <p>
                Orientações
                      ...
                      <li class="nav-item has-treeview">
            <a href="{{ route('estudante.enviar_mensagem') }}" class="nav-link" >
              <ion-icon name="newspaper"></ion-icon>
              <p>
                Enviar Mensagem
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('estudante.horario') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('estudante.falta') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('estudante.notificacao') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('estudante.ver_declaracao') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{ route('estudante.ver_relatos') }}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a  class="nav-link" href="{{ route('estudante.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color: red;">
  ...
  <div class="content-wrapper" id="centro" style=" @if(Auth::guard('estudante')->user()->liceu == 1)
