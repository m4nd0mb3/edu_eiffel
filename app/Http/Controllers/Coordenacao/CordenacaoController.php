...
class CordenacaoController extends Controller
{
    function create(Request $request){
        ...
        $request->validate([
            'name'=>'required',
            'email'=>'required|email|unique:coordenadors,email',
     ...
     ;
        ...
        if($request->hasFile('photo') && $request->file('photo')->isValid()){
          ...
          $requestImage->move(public_path('media/coordenadorimg'), $imageName);
      ...
      if($request->hasFile('bilhete') && $request->file('bilhete')->isValid()){
          ...
          $requestImage->move(public_path('media/coordenadorpdf'), $imageName);
  ...
  function check(Request $request){
      //Validate Inputs
      $request->validate([
         'email'=>'required|email|exists:coordenadors,email',
         'password'=>'required|min:5|max:30'
      ],[
      ...
      if( Auth::guard('coordenacao')->attempt($creds) ){
          return redirect()->route('coordenacao.home');
      }else{
          return redirect()->route('coordenacao.login')->with('fail','Credências incorretas');
      }
  }

  function logout(){
      Auth::guard('coordenacao')->logout();
      return redirect()->route('coordenacao.login');
  }
...
function home(){
    ...
    return view('dashboard.coordenador.home',['count_estudantes' => $count_estudantes,'count_professores' => $count_professores,'count_funcionarios' => $count_funcionarios,'count_planos' => $count_planos,
...
function boletim_liceu(){
    ...
    return view('dashboard.coordenador.boletim_liceu',[
        'caxito' => $caxito,
        'malanje' => $malanje,
...
function tipo_boletim( $liceu){
    ...
    return view('dashboard.coordenador.tipo_boletim',
...
function ver_nota_enviada($liceu){
    ...
    return view('dashboard.coordenador.ver_nota_enviada', ['totals' => $totals,]);
...
public function ver_nota_enviada_individual($liceu,$id){
    ...
    return view('dashboard.coordenador.ver_nota_enviada_individual', ['provas'=>$provas]);
}
...
public function ver_info_nota_enviada_individual($liceu,$id,$created_at){
    ...
    return view('dashboard.coordenador.ver_info_nota_enviada_individual', ['provas'=>$provas]);
}
...
function ver_nota_validada($liceu){
    ...
    return view('dashboard.coordenador.ver_nota_validada', ['totals' => $totals,]);
...
public function ver_nota_validada_individual($liceu,$id){
    ...
    return view('dashboard.coordenador.ver_nota_validada_individual', ['provas'=>$provas]);
}
...
public function ver_info_nota_validada_individual($liceu,$id,$created_at){
    ...
    return view('dashboard.coordenador.ver_info_nota_validada_individual', ['provas'=>$provas]);
}
...
function plano_liceu(){
    ...
    return view('dashboard.coordenador.plano_liceu',[
        'caxito' => $caxito,
        'malanje' => $malanje,
        'ndalatando' => $ndalatando,
        'ondjiva' => $ondjiva,
...
function plano_enviados($liceu){
    ...
    return view('dashboard.coordenador.plano_enviado',['totals' => $totals ]);
...
public function plano_individual($liceu,$id){
    ...
    return view('dashboard.coordenador.plano_individual', ['planos'=>$planos]);
}
...
function orientacao_liceu(){
    ...
    return view('dashboard.coordenador.orientacao_liceu',[
        'caxito' => $caxito,
        'malanje' => $malanje,
        'ndalatando' => $ndalatando,
        'ondjiva' => $ondjiva,
...
function orientacao_enviados($liceu){
    ...
    return view('dashboard.coordenador.orientacao_enviado',['totals' => $totals ]);
...
public function orientacao_individual($liceu,$id){
    ...
    return view('dashboard.coordenador.orientacao_individual', ['planos'=>$planos]);
}
...
function enviar_formacao(){
    ...
    return view('dashboard.coordenador.enviar_formacao',[
        'liceu' => $liceu,
...
function formacao_disciplina($id){
    ...
    return view('dashboard.coordenador.formacao_disciplina',[
...
function formacao_liceu($id){
    ...
    return view('dashboard.coordenador.formacao_liceu',[
...
function formacao(Request $request,$tipo){
    ...
    if($data){
        return redirect()->route('coordenacao.ver_formacao')->with('success','Formação Enviada das Com sucesso');
    }else{
...
function ver_formacao(){
    ...
    return view('dashboard.coordenador.ver_formacao',['formacoes' => $formacoes ]);
...
public function editar_formacao($id){
 ...
 $tipos = Type_formacao::all();
    ...
    return view('dashboard.coordenador.formacao.editar_formacao',[
        'formacoes' => $formacoes,
        'liceu' => $liceus,
        'disciplinas' => $disciplinas,
        'tipos' => $tipos,
   ...
   public function editar_form(Request $request){
    ...
    Formacao::where('id', $request->get('id'))->update($data);
            ...
            return redirect()->route('coordenacao.ver_formacao')->with('success','Formação editada das Com sucesso');
      }
      ...
      function eliminar_form(Request $request,$id){
        ...
        return redirect()->route('coordenacao.ver_formacao')->with('success','Formação eliminada das Com sucesso');
    }
    ...
    function directores_liceu(){
        ...
        return view('dashboard.coordenador.directores.directores_liceu',[
            'caxito' => $caxito,
            'malanje' => $malanje,
            'ndalatando' => $ndalatando,
            'ondjiva' => $ondjiva,
    ...
    function directores($liceu){
        ...
        return view('dashboard.coordenador.directores.directores',[
            'gerais' => $gerais,
         ...
         function info_directore($liceu,$id){
            ...
            return view('dashboard.coordenador.directores.info_directores',[
                'gerais' => $gerais,
                'url' => $url,
             ...
             function info_directore_A($liceu,$id){
                ...
                return view('dashboard.coordenador.directores.info_directores_A',[
                 ...
                 function info_directore_P($liceu,$id){
                    ...
                    return view('dashboard.coordenador.directores.info_directores_P',[
                     ...
                     function professor_liceu(){
                        ...
                        return view('dashboard.coordenador.professor.professor_liceu',[
                            'caxito' => $caxito,
                            'malanje' => $malanje,
                            'ndalatando' => $ndalatando,
                            'ondjiva' => $ondjiva,
                    ...
                    function professores($liceu){
                        ...
                        return view('dashboard.coordenador.professor.professores',[
    ...
    function info_professores($id){
        ...
        return view('dashboard.coordenador.professor.info_professores',[
...
function tipo_pedagogia(){
    ...
    return view('dashboard.coordenador.pedagogia.tipo_dado',[
        'count_orientacoes' => $count_orientacoes,
        'count_planos' => $count_planos,
...
function tipo_recurso(){
    ...
    return view('dashboard.coordenador.recursos.tipo_dado',[
...
function form(){
    ...
    $id = Auth::id();
      ...
      $coordenadores = Coordenador::findOrFail($id);
      
      return view('dashboard.coordenador.form', ['coordenadores' => $coordenadores]);
  ...
  function edit_inf(Request $request){
     ...
     // Coordenador::findOrFail($request->id)->update($request->all());
      ...
      if($request->hasFile('photo') && $request->file('photo')->isValid()){
          ...
          $requestImage->move(public_path('media/coordenacao/img'), $imageName);
      ...
      if($request->hasFile('hl') && $request->file('hl')->isValid()){
          ...
          $requestImage->move(public_path('media/coordenacao/pdf'), $imageName);
      ...
      if($request->hasFile('cv') && $request->file('cv')->isValid()){
        ...
        $requestImage->move(public_path('media/coordenacao/cv'), $imageName);
    ...
    if($request->hasFile('do') && $request->file('do')->isValid()){
        ...
        $requestImage->move(public_path('media/coordenacao/do'), $imageName);
    ...
    if($request->hasFile('sdo') && $request->file('sdo')->isValid()){
        ...
        $requestImage->move(public_path('media/coordenacao/sdo'), $imageName);
    ...
    if($request->hasFile('gm') && $request->file('gm')->isValid()){
        ...
        $requestImage->move(public_path('media/coordenacao/gm'), $imageName);
    ...
    Auth::guard('coordenacao')->user()->update($data);
    if( Auth::guard('coordenacao')->user()->update($data) ){
       return redirect()->route('coordenacao.home')->with('success','Dados Actualizados com sucesso');
   }
}
...
function ver_dados(){
    ...
    $id = Auth::id();
    $dados = Coordenador::where("id","=","$id")->get();

    return view('dashboard.coordenador.ver_dados', ['dados' => $dados]);
...
function diretoresO(){
    ...
    return view('dashboard.coordenador.directores',['liceus' => $liceus  ]);
...
public function ver_director($liceu){
    ...
    return view('dashboard.coordenador.ver_director', ['gerals'=>$gerals,'pedagogicos'=>$pedagogicos,'administrativos'=>$administrativos]);
}

public function ver_info_director($liceu, $id){
    $dados = Geral::where('liceu', '=', $liceu)->where('id', '=', $id)->get();

    return view('dashboard.coordenador.ver_info_director', ['dados'=>$dados]);
}
...
function ver_falta(){
    ...
    return view('dashboard.coordenador.ver_falta',['administrativos' => $administrativos,'pedagogicos' => $pedagogicos,'secretarios' => $secretarios  ]);
...
function secretarios(){
    ...
    return view('dashboard.coordenador.secretarios',['liceus' => $liceus  ]);
}
...
public function ver_secretario($liceu){
    ...
    return view('dashboard.coordenador.ver_secretarios', ['administrativos'=>$administrativos]);
}
...
public function ver_info_secretarioa($liceu, $id){
    ...
    return view('dashboard.coordenador.ver_info_secretario', ['dados'=>$dados]);
}
...
function lprofessores(){
    ...
    return view('dashboard.coordenador.lprofessores',['liceus' => $liceus  ]);
...
function prof($liceu){
    ...
    return view('dashboard.coordenador.prof',['professores' => $professores ]);
...
return view('dashboard.coordenador.ver_dados_professor', ['dados'=>$dados,'count_provas' => $count_provas,'count_orientacoes' => $count_orientacoes,'count_formacoes' => $count_formacoes,
...
function falta_professores(){
    ...
    return view('dashboard.coordenador.falta_professores',['liceus' => $liceus,
     ]);
...
function ver_falta_professor($liceu){
    ...
    return view('dashboard.coordenador.ver_falta_professor', ['totals' => $totals,]);
...
public function ver_info_falta_professor($liceu, $id){
    ...
    return view('dashboard.coordenador.ver_info_falta_professor', ['dados'=>$dados]);
}
...
function ldeclaracao(){
    ...
    return view('dashboard.coordenador.ldeclaracao',['liceus' => $liceus,
     ]);
...
function declaracao_professores($liceu){
    ...
    return view('dashboard.coordenador.declaracao_professores', ['totals' => $totals,]);
...
public function ver_declaracao_professor($liceu, $id){
    ...
    return view('dashboard.coordenador.ver_declaracao_professor', ['dados'=>$dados]);
}
...
function boletim_liceu(){
    ...
    return view('dashboard.coordenador.boletim_liceu',['liceus' => $liceus,
     ]);
...
function ver_notas($liceu){
    ...
    return view('dashboard.coordenador.ondjiva_notas', ['totals' => $totals,]);
...
public function ver_boletim_professor($id){
    ...
    return view('dashboard.coordenador.ver_nota_professor', ['provas'=>$provas]);
}
...
public function ver_info_nota_professor($liceu,$created_at){
    ...
    return view('dashboard.coordenador.ver_info_nota_professor', ['provas'=>$provas]);
}
...
function lplanos(){
    ...
    return view('dashboard.coordenador.lplanos',['liceus' => $liceus  ]);
...
function planos($liceu){
    ...
    return view('dashboard.coordenador.planos',['totals' => $totals ]);
...
public function ver_plano_professor($liceu,$id){
    ...
    return view('dashboard.coordenador.ver_plano_professor', ['planos'=>$planos]);
}
...
function lorientacoes(){
    ...
    return view('dashboard.coordenador.lorientacoes',['liceus' => $liceus  ]);
...
function orientacoes_enviadas($liceu){
    ...
    return view('dashboard.coordenador.ver_orientacoes', ['orientacoes' => $orientacoes]);
...
public function ver_orientacao_professor($liceu,$id){
    ...
    return view('dashboard.coordenador.ver_orientacao_professor', ['orientacoes'=>$orientacoes]);
}
...
function lestudantes(){
    ...
    return view('dashboard.coordenador.lestudantes',['liceus' => $liceus  ]);
...
function turma_as($liceu){
    ...
    return view('dashboard.coordenador.adec',['estudantes' => $estudantes ]);
...
public function ver_turma_as($liceu,$classe){
    ...
    return view('dashboard.coordenador.ver_turma_as', ['estudantes'=>$estudantes]);
}
...
//$disciplinas = Disciplina::all();
    ...
    $count_provas = count($provas);
    $count_declaracoes = count($declaracoes);
    return view('dashboard.coordenador.ver_dados_estudante', ['estudantes'=>$estudantes,'count_orientacoes' => $count_orientacoes,'count_provas' => $count_provas,
...
public function ver_individual($id){
    ...
    return view('dashboard.coordenador.ver_individual_nota', ['provas'=>$provas]);
}
...
function ver_festudante(){
    ...
    return view('dashboard.coordenador.ver_festudante',['liceus' => $liceus ]);
...
public function ver_falta_estudante($id){
    ...
    return view('dashboard.coordenador.ver_falta_estudante', ['provas'=>$provas]);
}
...
public function ver_info_falta_estudante($liceu,$classe){
    ...
    return view('dashboard.coordenador.ver_info_falta_estudante', ['totals' => $totals,]);
...
public function ver_info_falta_total_estudante($liceu,$classe,$id){
   ...
   return view('dashboard.coordenador.ver_info_falta_total_estudante', ['estudantes' => $estudantes]);
...
function declaracoes_estudantes(){
    ...
    return view('dashboard.coordenador.declaracoes_estudante',['liceus' => $liceus ]);
...
public function ver_declaracao_estudante($id){
    ...
    return view('dashboard.coordenador.ver_declaracao_estudante', ['declaracoes'=>$declaracoes]);
}
...
public function ver_info_declaracao_estudante($liceu){
    ...
    return view('dashboard.coordenador.ver_info_declaracao_estudante', ['declaracoes'=>$declaracoes]);
}
...
function funcionario(){
   ...
   $liceus = Liceu::all();
    ...
    return view('dashboard.coordenador.funcionario',['liceus' => $liceus ]);
...
public function ver_dado_funcionario($liceu){
    ...
    return view('dashboard.coordenador.ver_dados_funcionaro',['funcionarios' => $funcionarios, ]);
}
...
public function ver_info_funcionario($liceu,$id){
    ...
    return view('dashboard.coordenador.ver_info_funcionaro',['funcionarios' => $funcionarios, ]);
}
...
function ver_faltaf(){
    ...
    return view('dashboard.coordenador.ver_faltaf',['professores' => $professores ]);
...
function lnotificacao(){
    ...
    $liceuss = Tipo_Not::where('id', '=' ,2)->get();
     ...
     return view('dashboard.coordenador.lnotificacao',['liceus' => $liceus ,'liceuss' => $liceuss ]);
 ...
 public function enviar_individual($tipo){
    ...
    return view('dashboard.coordenador.enviar_individual',['liceus' => $liceus ]);}
    ...
    function not_estudantes(){
        ...
        return view('dashboard.coordenador.not_estudante',['liceus' => $liceus ]);
    ...
    function enviar_n($liceu,$classe){
        ...
        return view('dashboard.coordenador.enviar_n',['classes' => $classes]);
    }
    ...
    function dec_A(Request $request, $liceu, $classe){
      ...
      if($data){
        return redirect()->route('coordenacao.decima_A')->with('success','Falta Enviada das Com sucesso');
    }else{
        return redirect()->back()->with('fail','Notas não Enviadas');
    }}
    ...
    public function enviar_liceu($tipo){
        ...
        return view('dashboard.coordenador.enviar_liceu',['liceus' => $liceus ]);}
