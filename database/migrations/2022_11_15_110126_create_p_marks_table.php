...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('p_marks', function (Blueprint $table) {
            $table->id();
            $table->foreignId('classe')->references('id')->on('classes')->constrained()->onUpdate('cascade')->onDelete('cascade')->nullable();

            $table->foreignId('mix_id')->references('id')->on('mix_d_p_s')->constrained()->onUpdate('cascade')->onDelete('cascade')->nullable();
            $table->foreignId('liceu')->references('id')->on('liceus')->constrained()->onUpdate('cascade')->onDelete('cascade')->nullable();

            $table->string('nota')->nullable();
            $table->date('data')->nullable();
          
            $table->foreignId('tipo_id')->references('id')->on('typ__provas')->constrained()->onUpdate('cascade')->onDelete('cascade');
